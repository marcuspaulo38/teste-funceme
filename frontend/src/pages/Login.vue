    ...
    <div id="page-login">
        <div class="box-login-form">
            <form v-on:submit.prevent="login()" class="form w-100">
                <img src="/static/images/eu-logo.png" height="100px" class="image-login" /> 
                ...
                <hr>
                <div class="buttons">
                    <router-link to="/home" class="btn w-100">Visualize antes...</router-link>
                </div>
            </form>
        </div>
            ...
            login(){
                ...
                .then(response => {
                    if(response.data.token){
                        ...
                        this.errors.email = 'Usuário ou senha errado';
                    }
                })
                .catch(e => {
                    this.errors.email = 'Usuário ou senha errado';
