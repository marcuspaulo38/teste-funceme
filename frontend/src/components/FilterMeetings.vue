<template>
    <div id="filter-meeting">
        <div class="d-flex">
            <h3 class="title">Opções de busca</h3>
            <div class="ml-auto box-checkboxs">
                <label class="label-checkboxs" for="meetings-accept"><input type="checkbox" @change="filterMeetings()" v-model="filter.filteringMeetingsAccept" id="meetings-accept" /> Marcadas</label>
                <label class="label-checkboxs" for="new-meetings"><input type="checkbox" @change="filterMeetings()" v-model="filter.filteringNewMeetings" id="new-meetings" /> Recentes</label>
                <label class="label-checkboxs" for="future-meetings"><input type="checkbox" @change="filterMeetings()" v-model="filter.futureMeetings" id="future-meetings" /> Futuras</label>
            </div>
        </div>
